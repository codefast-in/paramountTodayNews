                ...
                <td className="py-4 px-6 text-center">
                  ...
                  {user?.permissions?.canDelete && (
                    <button
                      ...
                      className="p-2 bg-[#730101] text-white rounded-lg hover:bg-red-700 focus:outline-none ml-2"
                    >
                      Delete
                    </button>
                  )}
                  ...
                  <button
                    ...
                    className={`p-2  text-white ml-4 rounded-lg hover:bg-yellow-700 focus:outline-none ${
                      category.active ? "bg-green-600" : "bg-red-900"
                    }`}
                  >
                    {category.active
                      ? "Click To Deactivate"
